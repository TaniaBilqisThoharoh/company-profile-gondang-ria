...
export default function PesanTiket() {
  ...
  const beliHandler = () => {
    console.log(`jumlah tiket ${counter}`)
  }
  ...
  return (
    ...
    >
      ...
      <Ticket />
      <div className="w-[593px] h-[221px] bg-white bg-opacity-[5%] rounded-[20px] border-[3px] border-ble-200 backdrop-blur-[21px] flex flex-col gap-[40px] justify-center items-center">
        ...
        <Link href={`/pesan-tiket/data-diri`} onClick={beliHandler} className="grid place-items-center bg-ble-400 hover:bg-ble-500 text-ble-50 h-[63px] font-bold text-2xl rounded-[10px] w-[90%]">
          BELI SEKARANG
        </Link>
      </div>
    </main>
